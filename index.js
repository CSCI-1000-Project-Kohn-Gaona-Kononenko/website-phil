...
export default function Home() {
  return (
    <div className='container'>
      ...
      <main>
        <h1 className='title'>Welcome to my About Me Website! Привет!</h1>

        <p className='description'>
          My name is Phillip Kononenko, I am a Computer Science student here at CU Boulder.
        </p>
        <p className='description2'>
          Here is a little about me, who I am, and where I am from.
        </p>
